    ...
    "
        ?>
            ...
            <div class="sidenav-url">
                <div class="url">
                    <a href='profile.php?lo=1' class="btn logup">Đăng xuất</a>
                    <hr allign="center">
                </div>
                <div class="url">
                    <a href='profile.php?upd=1' class="btn logup">Cập nhật</a>
                    <hr allign="center">
                </div>
                <?php
        if (isset($_GET['odd'])) {
        ...
        <div class="main">
            ...
            <div class="card">
              ...
              <tr>
              <td><button name='submit' type='submit' class='btn' style='width: 50%;'>Cập Nhật</button></td>
      ...
      if (isset($_GET['odd'])) {
        ...
        echo "</tbody></table><div class='asd'><button type='submit' name='abc' class = 'btn' >Gửi</button></div>
                </form></tbody>
                  </table>
              </div>
          </div>
