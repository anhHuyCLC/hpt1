...
<head>
    <title>Quản lý kho thiết bị điện tử</title>
...
<body>
    <div class="container1">
        <div class="form-container">
            ...
            <form id="insert-form" action="inventory.php" enctype="multipart/form-data" method="post">
                ...
                <button name="ins" type="submit" class="insert-btn">Lưu</button>
            </form>
        </div>
    ...
    <div class="container11">
        <div class="order-container">
            ...
            <div class="btns">
                <a href='inventory.php?a=1'><button id="all-btn">Tất cả</button></a>
                <a href='inventory.php?d=1'><button id="delivered-btn">Đã giao</button></a>
                <a href='inventory.php?u=1'><button id="undelivered-btn">Chưa giao</button></a>
